...
5)	Ненужные "абибасы" удали, они для примера, как можно организовать обмен файлами со множеством организаций;
6)	Используй ярлык 'SOKOL-SOFT' для удобного запуска, можно переименовать его и изменить параметры на свой вкус;
